...
class ModelConfig(Base):
  ...
  mesh_config_name: Mapped[str] = mapped_column(
    ForeignKey("MeshConfig.name"), nullable=True, default_factory=lambda: None
  )
...
class RopeConfig(Base):
  ...
  min_timescale: Mapped[Integer] = mapped_column(
    Float, nullable=False, default_factory=lambda: 1
  )
  max_timescale: Mapped[Integer] = mapped_column(
    Float, nullable=False, default_factory=lambda: 10000
  )
